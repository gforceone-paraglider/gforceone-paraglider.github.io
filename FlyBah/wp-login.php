...
<html lang="en-GB">
	...
	<title>Log In &lsaquo; FlyBah Adventure &#8212; WordPress</title>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Go to FlyBah Adventure</a>		</p>
			</div>
...
var _wpUtilSettings = {"ajax":{"url":"\/FlyBah\/wp-admin\/admin-ajax.php"}};
</script>
<script src="./wp-includes/js/wp-util.min.js?ver=5.9.1" id="wp-util-js"></script>
<script id="user-profile-js-extra">
var userProfileL10n = {"user_id":"0","nonce":"04378cfd37"};
</script>
